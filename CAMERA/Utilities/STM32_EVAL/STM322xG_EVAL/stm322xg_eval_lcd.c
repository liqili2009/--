...
void LCD_SetDisplayWindow(uint16_t Xpos, uint16_t Ypos, uint8_t Height, uint16_t Width)
{
	...
	LCD_WriteReg(0x03, Xpos & 255);
	LCD_WriteReg(0x04, (Xpos + Height - 1)  >> 8);
	LCD_WriteReg(0x05, (Xpos + Height - 1) & 255);
	LCD_WriteReg(0x06, Ypos >> 8);
	LCD_WriteReg(0x07, Ypos & 255);
	LCD_WriteReg(0x08, (Ypos + Width - 1) >> 8);
	LCD_WriteReg(0x09, (Ypos + Width - 1) & 255);
#else
