...
#define CAMERA_PLUG_PIN                 IO_Pin_5
/**
  * @brief Eval Board both IO Exapanders Pins definition 
  */ 
#define IO1_IN_ALL_PINS          (uint32_t)(CAMERA_PLUG_PIN)
#define IO2_IN_ALL_PINS          (uint32_t)(JOY_IO_PINS)
#define IO1_OUT_ALL_PINS         (uint32_t)(CAMERA_PLUG_PIN)
...
/** 
  ...
  */ 
#define IOE_REG_GPIO_SET_PIN       0x01
#define IOE_REG_GPIO_CLR_PIN       0x01
...
#define IOE_REG_GPIO_DIR           0x03
//#define IOE_REG_GPIO_DIROUT          0x03
#define IOE_REG_GPIO_MP_STA          0x00
/** 
  * @brief  ADC Registers  
  */ 
