...
/** @addtogroup STM322xG_EVAL_FSMC_SRAM
  * @brief     This file provides a set of functions needed to drive the 
  *            CY7C1071DV33-12BAXI SRAM memory mounted on STM322xG-EVAL board.
  * @{
  */
...
/*-- FSMC Configuration ------------------------------------------------------*/
  ...
  FSMC_NORSRAMInitStructure.FSMC_MemoryType = FSMC_MemoryType_SRAM;//FSMC_MemoryType_SRAM;//FSMC_MemoryType_PSRAM;
