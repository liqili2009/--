#ifndef _DCMI_OV7670_H
#define _DCMI_OV7670_H
...
/* * Basic window sizes.  These probably belong somewhere more globally * useful. */
...
#define	QCIF_HEIGHT	144/* * The 7670 sits on i2c with ID 0x42 */
#define OV7670_I2C_ADDR 0x42/* Registers */
